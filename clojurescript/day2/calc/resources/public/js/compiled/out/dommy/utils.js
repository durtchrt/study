 ...
 */
dommy.utils.dissoc_in = (function dommy$utils$dissoc_in(m,p__38905){
...
return [cljs.core.str((function (){var G__38913 = cljs.core.namespace.call(null,s);
if((G__38913 == null)){
return null;
} else {
return [cljs.core.str(G__38913),cljs.core.str("/")].join('');
}
...
var and__24860__auto__ = ((idx === (0))) || ((" " === class_name.charAt((idx - (1)))));
if(and__24860__auto__){
...
var G__38915 = (function (){var end = (i + class$.length);
...
//# sourceMappingURL=utils.js.map?rel=1486440935405