...
var or__24872__auto__ = cljs.core.get.call(null,new cljs.core.Keyword(null,"namespaces","namespaces",-1444157469).cljs$core$IFn$_invoke$arity$1(m),s);
...
if((i__$1 > (0))){
var G__39792 = s__$1.replace(hipo.hiccup.class_separator," ");
s__$1 = G__39792;
continue;
} else {
return s__$1;
...
if(cljs.core.truth_((function (){var and__24860__auto__ = id;
...
if(cljs.core.truth_((function (){var or__24872__auto__ = id;
if(cljs.core.truth_(or__24872__auto__)){
return or__24872__auto__;
} else {
return cs;
...
hipo.hiccup.Sentinel.cljs$lang$ctorPrWriter = (function (this__25478__auto__,writer__25479__auto__,opt__25480__auto__){
return cljs.core._write.call(null,writer__25479__auto__,"hipo.hiccup/Sentinel");
});
...
var G__39794 = (function (){var f = cljs.core.first.call(null,s);
if(cljs.core.truth_((function (){var or__24872__auto__ = hipo.hiccup.literal_QMARK_.call(null,f);
if(cljs.core.truth_(or__24872__auto__)){
return or__24872__auto__;
} else {
...
var G__39795 = cljs.core.rest.call(null,s);
v = G__39794;
s = G__39795;
continue;
} else {
...
var G__39796 = ((cljs.core.seq_QMARK_.call(null,f))?hipo.hiccup.conjs_BANG_.call(null,acc,f):((!((f == null)))?cljs.core.conj_BANG_.call(null,acc,f):acc
));
var G__39797 = cljs.core.subvec.call(null,v__$1,(1));
acc = G__39796;
v__$1 = G__39797;
continue;
}
...
//# sourceMappingURL=hiccup.js.map?rel=1486441495233