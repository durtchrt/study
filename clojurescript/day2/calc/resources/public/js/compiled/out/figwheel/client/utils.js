...
return (new CustomEvent(event_name,(function (){var obj31713 = {"detail":data};
return obj31713;
})()));
} else {
...
args31718.push((arguments[i__25948__auto___31725]));
...
var f = (function (){var pred__31721 = cljs.core._EQ_;
var expr__31722 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__31721.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__31722))){
return ((function (pred__31721,expr__31722){
return (function (p1__31714_SHARP_){
return console.warn(p1__31714_SHARP_);
});
;})(pred__31721,expr__31722))
} else {
if(cljs.core.truth_(pred__31721.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__31722))){
return ((function (pred__31721,expr__31722){
return (function (p1__31715_SHARP_){
return console.debug(p1__31715_SHARP_);
});
;})(pred__31721,expr__31722))
} else {
if(cljs.core.truth_(pred__31721.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__31722))){
return ((function (pred__31721,expr__31722){
return (function (p1__31716_SHARP_){
return console.error(p1__31716_SHARP_);
});
;})(pred__31721,expr__31722))
} else {
return ((function (pred__31721,expr__31722){
return (function (p1__31717_SHARP_){
return console.log(p1__31717_SHARP_);
});
;})(pred__31721,expr__31722))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__31728){
var map__31731 = p__31728;
...
var opts = map__31731__$1;
var eval_fn = cljs.core.get.call(null,map__31731__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__31733_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__31735,(0),null);
...
var args31738 = [];
var len__25947__auto___31741 = arguments.length;
var i__25948__auto___31742 = (0);
while(true){
if((i__25948__auto___31742 < len__25947__auto___31741)){
args31738.push((arguments[i__25948__auto___31742]));

var G__31743 = (i__25948__auto___31742 + (1));
i__25948__auto___31742 = G__31743;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args31738.length)].join('')));
...
//# sourceMappingURL=utils.js.map?rel=1486440323648