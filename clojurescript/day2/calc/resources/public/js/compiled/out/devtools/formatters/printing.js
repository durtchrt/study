...
var len__25947__auto___38070 = arguments.length;
var i__25948__auto___38071 = (0);
while(true){
if((i__25948__auto___38071 < len__25947__auto___38070)){
args__25954__auto__.push((arguments[i__25948__auto___38071]));

var G__38072 = (i__25948__auto___38071 + (1));
i__25948__auto___38071 = G__38072;
continue;
} else {
}
break;
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq38067){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__38068,G__38069,seq38067__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__38073_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__38073_SHARP_));
})))){
...
var markup_db = cljs.core.get.call(null,map__38082__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e38086){var e__35436__auto__ = e38086;
return false;
}})();
if(cljs.core.truth_(or__24872__auto__)){
return or__24872__auto__;
...
}catch (e38088){var e__35436__auto__ = e38088;
return false;
}}
})())){
...
var _STAR_current_state_STAR_38093 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__38094 = opts;
var map__38094__$1 = ((((!((map__38094 == null)))?((((map__38094.cljs$lang$protocol_mask$partition0$ & (64))) || (map__38094.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__38094):map__38094);
var markup_db = cljs.core.get.call(null,map__38094__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_38093;
}});
...
;
var temp__4655__auto___38099 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___38099)){
var managed_print_level_38100 = temp__4655__auto___38099;
var _STAR_print_level_STAR_38098_38101 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_38100;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_38098_38101,managed_print_level_38100,temp__4655__auto___38099,writer,opts,job_fn){
return (function (p1__38096_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__38096_SHARP_,null);
});})(_STAR_print_level_STAR_38098_38101,managed_print_level_38100,temp__4655__auto___38099,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_38098_38101;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1486440329810