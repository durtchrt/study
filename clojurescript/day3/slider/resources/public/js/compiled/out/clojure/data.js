...
return cljs.core.reduce.call(null,(function (result,p__37773){
...
var vec__37780 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__37780,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__37780,(1),null);
var ab = cljs.core.nth.call(null,vec__37780,(2),null);
...
var args37783 = [];
var len__25947__auto___37786 = arguments.length;
var i__25948__auto___37787 = (0);
while(true){
if((i__25948__auto___37787 < len__25947__auto___37786)){
args37783.push((arguments[i__25948__auto___37787]));

var G__37788 = (i__25948__auto___37787 + (1));
i__25948__auto___37787 = G__37788;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args37783.length)].join('')));
...
return (function (){var G__37793 = (((clojure.data.equality_partition.call(null,a) instanceof cljs.core.Keyword))?clojure.data.equality_partition.call(null,a).fqn:null);
switch (G__37793) {
case "atom":
...
//# sourceMappingURL=data.js.map?rel=1486526670898