...
var o__35411__auto___38813 = (function (){var o__35411__auto__ = (function (){var o__35411__auto__ = Promise;
return goog.object.get(o__35411__auto__,"resolve").call(o__35411__auto__);
})();
return goog.object.get(o__35411__auto__,"then").call(o__35411__auto__,callback);
})();
goog.object.get(o__35411__auto___38813,"catch").call(o__35411__auto___38813,devtools.async.rethrow_outside_promise);
...
var G__38815_38816 = Error;
var target__35430__auto___38817 = G__38815_38816;
if(cljs.core.truth_(target__35430__auto___38817)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("unable to locate object path "),cljs.core.str(null),cljs.core.str(" in "),cljs.core.str(G__38815_38816)].join('')),cljs.core.str("\n"),cljs.core.str("target__35430__auto__")].join('')));
}

goog.object.set(target__35430__auto___38817,cljs.core.last.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["stackTraceLimit"], null)),Infinity);
...
//# sourceMappingURL=async.js.map?rel=1486526672295