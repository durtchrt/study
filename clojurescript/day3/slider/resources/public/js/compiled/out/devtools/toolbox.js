...
var args38473 = [];
var len__25947__auto___38479 = arguments.length;
var i__25948__auto___38480 = (0);
while(true){
if((i__25948__auto___38480 < len__25947__auto___38479)){
args38473.push((arguments[i__25948__auto___38480]));

var G__38481 = (i__25948__auto___38480 + (1));
i__25948__auto___38480 = G__38481;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args38473.length)].join('')));
...
if(typeof devtools.toolbox.t_devtools$toolbox38476 !== 'undefined'){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox38476 = (function (obj,header,style,tag,meta38477){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
devtools.toolbox.t_devtools$toolbox38476.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_38478,meta38477__$1){
var self__ = this;
var _38478__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox38476(self__.obj,self__.header,self__.style,self__.tag,meta38477__$1));
});

devtools.toolbox.t_devtools$toolbox38476.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_38478){
var self__ = this;
var _38478__$1 = this;
return self__.meta38477;
});

devtools.toolbox.t_devtools$toolbox38476.prototype.devtools$protocols$IFormat$ = true;

devtools.toolbox.t_devtools$toolbox38476.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox38476.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
});

devtools.toolbox.t_devtools$toolbox38476.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox38476.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta38477","meta38477",1668244001,null)], null);
});

devtools.toolbox.t_devtools$toolbox38476.cljs$lang$type = true;

devtools.toolbox.t_devtools$toolbox38476.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox38476";

devtools.toolbox.t_devtools$toolbox38476.cljs$lang$ctorPrWriter = (function (this__25478__auto__,writer__25479__auto__,opt__25480__auto__){
return cljs.core._write.call(null,writer__25479__auto__,"devtools.toolbox/t_devtools$toolbox38476");
});

devtools.toolbox.__GT_t_devtools$toolbox38476 = (function devtools$toolbox$__GT_t_devtools$toolbox38476(obj__$1,header__$1,style__$1,tag__$1,meta38477){
return (new devtools.toolbox.t_devtools$toolbox38476(obj__$1,header__$1,style__$1,tag__$1,meta38477));
});

}

return (new devtools.toolbox.t_devtools$toolbox38476(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
});
...
//# sourceMappingURL=toolbox.js.map?rel=1486526671932