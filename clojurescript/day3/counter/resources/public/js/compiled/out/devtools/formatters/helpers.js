...
var G__38029 = devtools.prefs.pref.call(null,v);
v = G__38029;
continue;
} else {
return v;
...
}catch (e38042){var e__35436__auto__ = e38042;
return false;
}})();
...
}catch (e38046){var e__35436__auto__ = e38046;
return false;
}})();
...
}catch (e38048){var e__35436__auto__ = e38048;
return false;
}}
}
});
...
var vec__38053 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__38053,(0),null);
var name = cljs.core.nth.call(null,vec__38053,(1),null);
...
return cljs.core.some.call(null,(function (p1__38056_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__38056_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1486525852939