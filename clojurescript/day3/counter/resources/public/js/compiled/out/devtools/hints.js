...
var line = cljs.core.get.call(null,map__38840__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__38840__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e38839){var _e = e38839;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___38842 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___38842)){
var seen_errors_38843 = temp__4655__auto___38842;
if(cljs.core.truth_(seen_errors_38843.has(self))){
} else {
seen_errors_38843.add(self);

var temp__4657__auto___38844 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___38844)){
var sense_38845 = temp__4657__auto___38844;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_38845)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1486525854114